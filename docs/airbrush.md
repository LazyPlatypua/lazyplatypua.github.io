...
Если вы уже довольно долго занимаетесь покраской миниатюр, хорошим решением будет покупка аэрографа. Он поможет оптимизировать процесс и упростит многие этапы: грунтовка, лакирование, покраска больших поверхностей.
...
- позволяет использовать [зенитальный хайлайтинг](zenithal-highlighting.md).

Минусы:

- новый инструмент, для которого нужно разрабатывать новый навык;
- комплект аэрографа и компрессора довольно дорогой;
- требует дополнительных инструментов: подставка, коробка для покраски, щетки и жидкость для чистки, перчатки и респиратор;
- нужно место для хранения и покраски, желательно с хорошей вентиляцией;
...
- ознакомьтесь с алгоритмом покраски.
...
- Диаметром сопла и иглы:
    - для грубых работ (грунтовка, покрытие лаком, покраска больших поверхностей) подойдут диаметры 0.8-0.4 мм;
...
- Подставка для аэрографа — во время смешивания красок или перерывов в покраске держит аэрограф, чтобы содержимое бачка не пролилось.
...
- Бокс для покраски — чтобы не распылять краску по всей комнате и частично фильтровать воздух. Профессиональные боксы стоят дорого, но их можно заменить самодельными из картонной коробки или пластикового контейнера — тогда в роли фильтра можно использовать мокрое полотенце, прикрепленное к отверстию на задней части бокса.
...
После этого краску можно добавлять в аэрограф и использовать для покраски.
