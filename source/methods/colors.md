...
Рекомендации, инструкции и значения на этой странице субъективны. Впечатления от цветов, композиция и предпочтения индивидуальны, поэтому изменяйте и применяйте инструкции так, как больше нравится вам.

{% endnote %}

## Выбрать цвета при помощи круга

Цветовой круг — это способ представления цветов и их взаимоотношений друг с другом. Он помогает подобрать цвета, если их сложно выбрать изначально.

Чтобы подобрать цвета при помощи круга:

1. Определите цветовой круг. Есть несколько видов цветовых кругов в зависимости от главных цветов круга:

   - RYB (Red, Yellow & Blue — «Красный, желтый и синий»);
   - CMY (Cyan, Magenta & Yellow — бирюзовый, маджента и желтый») используется для печати и реже виден на миниатюрах.
   - Круг RGB (Red, Green & Blue — «Красный, зеленый и синий») не рассматривается. Он используется для цифровой передачи цвета и затрудняет работу при работе с акриловыми красками — желтый из этих трех этих цветов не получить.

    ![circles](../_images/the-state-of-play/circles.png "Источник: The State of Play" =400x)

    Основные цвета круга можно использовать для получения всех остальных.

2. Выберите основной доминирующий цвет.
3. Выберите сочетание цветов:

    ![harmonies](../_images/the-state-of-play/harmonies.png "Источник: The State of Play" =400x)

    Например, вы хотите выбрать остальные цвета для вашего основного желтого. Тогда вы можете выбрать следующие цвета из сочетаний CMY:

    #|
    || **Сочетание** | **Основной цвет** | **Вторичный цвет** | **Акценты** ||
    || Одноцветное

    Для цветов теней и высветлений одной поверхности.|Желтый | Желтый|Желтый ||
    || Аналогичное

    Для цветовых переходов одной поверхности.|Желтый |Зеленый | Оранжевый ||
    || Дополнительное

    Для цветов теней и высветлений одной поверхности.|Желтый |Синий | — ||
    || Разбитое дополнение

    Для контрастных цветовых схем.|Желтый |Синий | Фиолетовый||
    || Треугольное
    ![magos](../_images/the-state-of-play/magos.png)
    Для стандартных цветовых схем.|Желтый |Бирюзовый |Маджента ||
    || Квадратное

    ![keeper](../_images/the-state-of-play/keeper.png)
    |Желтый |Маджента | Синий
    Бирюзовый||
    || Прямоугольное |Желтый | Синий| Голубой
    Оранжевый||
    |#

    Вы можете поменять местами цвета из столбцов  **Вторичный цвет** и **Акценты**. Например, в аналогичном сочетании сделать вторичным цветом оранжевый, а акценты — зелеными.

    Вы можете заменить один или несколько цветов из сочетания на нейтральные: коричневый, серый, белый и черный. Так у вас получится менее разнообразная, но более целостная схема.

    ![eldar](../_images/the-state-of-play/eldar.png "Источник: The State of Play" =400x)

4. Определите нейтральные цвета: коричневый, серый, белый и черный. Эти цвета не привлекают внимания, не влияют на общую цветовую схему и заполняют неважные части миниатюры. Например, ремни, штаны, рога, посохи и сумки.
5. Определите расположение цветов. Вы можете воспользоваться рекомендацией «60 30 10»:

   - Основной цвет заполняет 60% миниатюры.
   - Вторичный цвет заполняет 30%.
   - Акценты находятся на оставшихся 10%.
  
    ![nurgle](../_images/the-state-of-play/nurgle.png "Источник: The State of Play" =400x)

6. Определите насыщенность цветов. Если все цвета будут чистыми, то они будут бороться за внимание и прочесть миниатюру будет сложнее.
7. Определите высветления и тени для каждого из выбранных цветов при помощи одноцветного, аналогичного и дополнительного сочетаний цветов. Основной цвет поверхности будет читаться таким же даже при использовании другого на этих мест.

   Например, желтый шлем останется желтым даже при глубоких оранжевых тенях и бело-зеленых высветлениях.
...
- Для теней используйте синий (для сильного контраста), фиолетовый (для контрастных насыщенных теней), зеленый (для более реалистичных) и коричневый (для ненасыщенных и грязных).
  Если вы хотите избежать плоской миниатюры и не будете использовать сильный контраст для теней красных поверхностей, то вам придется делать это при помощи высветлений. Это труднее и часто перемещает цвет в желтые и оранжевые тона.
- Для высветлений используйте оранжевый, светлые тона кожи и пастельный желтый. Не переусердствуйте с высветлениями, чтобы поверхность продолжала читаться красной с оранжевыми высветлениями, а не оранжевой.
  
    Если для высветлений использовать белый, то поверхность будет читаться розовой. Сделать плавный переход будет сложнее и поверхность потеряет насыщенность.

- Красно-коричневый цвет хорошо подходит для лессировки грязи и пыли. У вас получатся грязные, но при этом насыщенные переходы.
|
- Активность
- Дружелюбие
- Уверенность
...
- Используйте ярко желтый для лессировки на верхних частях кожи, чтобы сделать телесный цвет более живым.
|
...
- Зеленый плохо работает в тенях других цветов.
- Дополнительный цвет — красно-фиолетовый. Используйте его для реалистичных теней и контрастных высветлений.
- Для теней используйте фиолетовый, синий и красный.
- Для высветлений используйте желтый, розовый.
- Внесите в зеленый коричневый для создания грязного ощущения. Например, камуфляж или грязная роба.
- Внесите в зеленый оранжевый или желтый для создания опасного ощущения.  Например, цвет радиоактивного излучения или [цвет пожарной машины в некоторых частях мира](https://en.wikipedia.org/wiki/Chartreuse_(color)#Firefighting) (Wikipedia).
...
- Синий хорошо подходит для теней. Он придает ощущение темной и мрачной атмосферы.
- Красные тени на синей поверхности создают глубокий насыщенный цвет.
...
- Можете использовать для добавления жизни и яркости на важные места миниатюры. Например, смешайте мадженту с водой до лессировки и добавьте на лицо между средним тоном и тенями.
|
...
- При добавлении в другие цвета белый поглощает насыщенность, поэтому поверхности смотрятся скучнее. Вместо белого для используйте оттенки. Вместе с другими красками на модели они будут читаться как белый, несмотря на их принадлежность к цветам, и будут смотреться более интересно. Например, цвет слоновой кости (Ivory), теплый серый (Warm Grey) и белый (Warm White), телесные (Vampiric Flesh или Elfic Flesh), песочные (Pale Sand) и пастельные (Green grey, Pastel Blue или Pastel Violet) тона.
...
- [«COLOUR THEORY for Painting MINIATURES makes no sense, right?» от The State of Play](https://youtu.be/bnnFEBms7tw?si=i1Hf_f8R8WW7N05y) (Youtube)
...
- [«3+2 Simple Color Tricks for Miniature Painting» от Ph3lan's Miniatures](https://youtu.be/hJg_PoHXdA8?si=XoY_tmOT6FMdzOnl) (Youtube)