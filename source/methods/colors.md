...
- Комплиментарный цвет — красно-оранжевый. Можете его использовать для естественных теней (получится тепло-серый) и высветлений (получится зеленоватый).
- Для теней также можете использовать фиолетовый и темно-сине-зеленый.
- Для высветлений можете использовать белый, лиловый, холодный желтый и телесные цвета. Например, персиковый.
