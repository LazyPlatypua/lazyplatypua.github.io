...
- Красный цвет сильно выделяется, поэтому используйте его умеренно и сбалансировано. Размещайте его на важных местах на миниатюре и не концентрируйте в одном месте — например, используйте три фокусные красные точки.
...
- Оранжевый цвет сильно выделяется, поэтому используйте его умеренно и сбалансировано. Размещайте его на важных местах на миниатюре и не концентрируйте в одном месте — например, используйте три фокусные оранжевые точки.
- Акриловые краски этого цвета очень прозрачные, поэтому подложка сильно влияет на конечный результат.
...
- Желтый цвет сильно выделяется, поэтому используйте его умеренно и сбалансировано. Размещайте его на важных местах на миниатюре и не концентрируйте в одном месте — например, используйте три фокусные желтые точки.
- Акриловые краски этого цвета очень прозрачные, поэтому подложка сильно влияет на конечный результат.
