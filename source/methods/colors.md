...
Есть два полезных для покраски миниатюр вида цветовых кругов. В их названиях отражаются главные цвета круга:

- RYB (Red, Yellow & Blue — «Красный, желтый и синий»);
- CMY (Cyan, Magenta & Yellow — бирюзовый, маджента и желтый»).

![circles](../_images/the-state-of-play/circles.png)

Основные цвета этих кругов можно использовать для получения всех остальных цветов.

Круг RGB (Red, Green & Blue — «Красный, зеленый и синий») используется для цифровой передачи цвета и затрудняет работу — желтый из трех этих цветов не получить.
